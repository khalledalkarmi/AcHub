...
@section('content')
    ...
    <!-- MDB -->
    <script
        type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/mdb-ui-kit/6.1.0/mdb.min.js"></script>
    <main id="main">
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <h5 class="mb-3"><a href="/courses" class="text-body"><i
                                    ...
                                    <div class="col-lg-5">
                                        ...
                                        <div class="card  text-white rounded-3" style="background: #5fcf80; ">
                                            <div class="card-body">
                                                <div class="d-flex justify-content-between align-items-center mb-4">
                                                ...
                                                <button type="button" class="btn shadow-lg btn-block btn-lg">
                                                    <div class="d-flex justify-content-between">
                                                        <span>$4818.00</span>
